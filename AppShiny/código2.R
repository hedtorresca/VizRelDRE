...
countriesmap2 <- leaflet(countries)

for (k in c(1 , 2 , 3)) {
  countriesmap2 <- countriesmap2 %>% addProviderTiles(names(esri[k])  , group = names.esri[k] ,  options =  providerTileOptions(minZoom = 2))
}

countriesmap2 <- countriesmap2 %>%
